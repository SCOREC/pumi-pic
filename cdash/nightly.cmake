...
set(CTEST_DASHBOARD_ROOT "/users/d_zxg06726/nightlyBuilds/pumipic_build/" )
...
set(REPO_URL_BASE "https://github.com/SCOREC/pumi-pic")
set(BRANCH "master")
...
# set(GROUP_NAME "PUMIPic")
set_property(GLOBAL PROPERTY SubProject "pumi-pic")
set_property(GLOBAL PROPERTY Label "pumi-pic")
...
SET(CONFIGURE_OPTIONS
  ...
  "-DPS_IS_TESTING=ON"
  "-DENABLE_CABANA=ON"
  "-DCabana_PREFIX=${CTEST_DASHBOARD_ROOT}/build-Cabana/install/"
  "-DOmega_h_DIR=${CTEST_DASHBOARD_ROOT}/build-omega_h/install/lib64/cmake/Omega_h/"
  "-DEnGPar_DIR=${CTEST_DASHBOARD_ROOT}/build-EnGPar/install/lib/cmake/EnGPar"
  "-DTEST_DATA_DIR=${CTEST_DASHBOARD_ROOT}/pumipic-data"
