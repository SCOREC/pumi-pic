...
kk=/lore/gopan/install/build-kokkos-cuda-debug-profile-rhel7-pachisi/install
omega_h=/lore/gopan/install/build-omegah-cuda-rhel7-pachisi/install
cuda=/usr/local/cuda-10.1
export PATH=$cuda/bin:$PATH
export LD_LIBRARY_PATH=$cuda/lib64:$ncxx/lib64:$LD_LIBRARY_PATH
export CMAKE_PREFIX_PATH=${kk}:$omega_h:$ncxx:$ncxx/lib64/cmake/netCDFCxx:$CMAKE_PREFIX_PATH
